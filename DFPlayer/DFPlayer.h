...
#define DFPlayer_UART               SYSCTL_PERIPH_UART1
#define DFPlayer_UART_GPIO          SYSCTL_PERIPH_GPIOB
#define DFPlayer_UART_RX            GPIO_PB0_U1RX
#define DFPlayer_UART_TX            GPIO_PB1_U1TX
#define DFPlayer_GPIO_BASE          GPIO_PORTB_BASE
#define DFPlayer_GPIO_PIN           (GPIO_PIN_0 | GPIO_PIN_1)
#define DFPlayer_UART_BASE          UART1_BASE
#define DFPlayer_Baudrate           9600
#define DFPlayer_UART_Config        (UART_CONFIG_WLEN_8 | UART_CONFIG_STOP_ONE | UART_CONFIG_PAR_NONE)
#define DFPlayer_UART_INT           INT_UART1
#define DFPlayer_UART_INT_Config    (UART_INT_RX | UART_INT_RT)
